##############################################
#        food-web positive interactions      #
...
# interactions
# effect of column species (.c) on row species (r.)
...
i12.12 = abs(e*(-o*(Blepharisma/Blepharisma)^p))

# food-web
fullFW_pos <- (rbind(cbind(i4.4,i4.5,i4.6,i4.7,i4.8,i4.9,i4.11,i4.12),
